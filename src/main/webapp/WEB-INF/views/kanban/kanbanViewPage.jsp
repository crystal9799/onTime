	            ...
	            <form id="createProjectForm">
	                <div class="modal-body"><br>
	                	<div class="form-group">
	                		<label for="project_num">프로젝트 번호</label>
	                		<input type="number" class="form-control" id="project_num" name="id" value="11" disabled="disabled">
	                	</div><br>
	                	<div class="form-group">
	                	<label for="project_num">사원 선택</label><br>
		                	<select id="nameList" class="form-control">
								<option value="0">선택</option>
							</select>
	                	</div><br>
	                    <div class="form-group">
	                        <label for="project_name"> 업무 내용</label>
	                        <input type="text" class="form-control" id="todo-input" name="title" required>
	                    </div><br>
	                </div>
	                <div class="modal-footer">
	                    <button type="button" class="btn btn-secondary" data-dismiss="modal" id="closeBtn">close</button> 
	                    <a href="${pageContext.request.contextPath}/getProjectDetail.do"" type="button" class="btn btn-success" id="addBtn">Save</a>
	                </div>
				</form>
...
<%-- 						<button class="modalBtn">add</button>
						...
						<button>
							<a href="${pageContext.request.contextPath}/getProjectDetail.do"
								style="text-decoration: none; color: black">refresh</a>
						</button> --%>
						<br>
					...
					<div class="btnClass">
						<div>
							<span>
					<!-- 			<a type="button" class="modalBtn" id="plus">+</a>  -->
 					...
 					<a href="${pageContext.request.contextPath}/getProjectDetail.do" id="reBtn" class="fa fa-refresh"  type="button" style="text-decoration:none; color:#4b49ac;"> </a>
					...
					<div class="lanes">
						...
						<div class="swim-lane" id="todo-prev">
							...
							<c:forEach var="plist" items="${plist}">
								<p class="btn btn-inverse-primary btn-fw" draggable="true" id='${plist.sched_num}'>${plist.sched_info}</p>
							</c:forEach>
						</div>
						...
						<div class="swim-lane" id="todo-curr">
							...
							<c:forEach var="clist" items="${clist}">
								<p class="btn btn-inverse-primary btn-fw" draggable="true" id='${clist.sched_num}'>${clist.sched_info}</p>
							</c:forEach>
						</div>
						...
						<div class="swim-lane" id="todo-next">
							...
							<c:forEach var="nlist" items="${nlist}">
								<p class="btn btn-inverse-primary btn-fw" draggable="true" id='${nlist.sched_num}'>${nlist.sched_info}</p>
							</c:forEach>
						</div>	
