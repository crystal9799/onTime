	...
	$(document).ready(function() {
		...
		file.onchange = function() {
			...
			reader.onload = function() {
				document.querySelector('#fileImg').src = reader.result;
			};
		};
				...
				<div class="cardWrapper">
					<div class="mypageCard">
						...
						<div class="userAvater">
							<form>
								<input id="fileImageUpload" class="userImage" type="file" accept="image/*" onChange="" />
								...
								<div class="saveButtonWrapper" onclick="">
							...
							<form id="userFrom" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="emp_pic">Employee Picture:</label> <input
										type="file" name="file" class="form-control-file" id="emp_pic">
								</div>
